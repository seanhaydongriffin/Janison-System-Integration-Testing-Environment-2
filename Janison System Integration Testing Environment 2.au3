...
Local $app_name = "Janison System Integration Testing Environment 2"
...
$storage_format = '<a href=\"https://janisoncls.atlassian.net/wiki/download/attachments/494207048/Janison%20System%20Integration%20Testing%20Environment%202%20portable.exe\">Click to update page</a><br /><br />'
...
Local $deployment = _OctopusGetLatestTenantIdsDeploymentIdTaskIdCreatedForEnvironment("Environments-41")
...
for $subscription_num = 0 to (UBound($subscription_arr) - 1)
	...
	$ps_script_arr[1] = "Get-AzureRmResource -ResourceType 'Microsoft.Sql/servers' -ResourceGroupName '*-SIT2'"
...
Update_Confluence_Page("https://janisoncls.atlassian.net", "JAST", "495845841", "495747639", "System Integration Testing Environment 2", $storage_format)
